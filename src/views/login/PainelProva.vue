...
<template>
  <section
    ...
    "
    aria-labelledby="painel-prova-titulo"
  >
    <div class="flex flex-col gap-2">
      ...
      <h2 id="painel-prova-titulo" class="text-section-title">
    ...
    <Card :class="CARD_SURFACE">
      ...
      <CardContent class="border-border flex flex-col gap-2.25 border-t px-4 py-3.5">
        ...
        <div class="flex h-2.5 overflow-hidden rounded-sm" aria-hidden="true">
          <span
            v-for="item in wallet.allocationPreview"
            :key="item.label"
            class="h-full"
