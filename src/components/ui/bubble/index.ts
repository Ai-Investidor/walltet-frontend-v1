...
export const bubbleVariants = cva('group/bubble relative flex w-fit min-w-0 flex-col', {
  variants: {
    variant: {
      default:
...
export const bubbleReactionsVariants = cva(
  'rounded-none ring-2 ring-card bg-muted shrink-0 gap-1 px-1.5 py-0.5 has-[button]:p-0 text-xs absolute z-10 flex w-fit items-center justify-center',
  {
    variants: {
      side: {
